...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let newe = new_id () in
    evt := {id = newe; action = listener} :: !evt ;
    newe 
...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let new_lst = List.filter (fun {id; action} -> id <> i) !evt in
    evt := new_lst 
...
let first = WEvent.add_listener newswire fakeNewsNetwork ;;
let second = WEvent.add_listener newswire buzzFake ;;
...
WEvent.remove_listener newswire first ;;
WEvent.remove_listener newswire second ;;
...
WEvent.fire_event publish h5 ;;
WEvent.fire_event publish h6 ;;
